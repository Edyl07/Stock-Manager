...
public class Fournisseur {
    ...
    public Fournisseur(long id, String code, String libelle, String contact, String adresse, String tel, String matFisc, String asujet, String timbre, float soldeInit, float solde, String login, String password) {
        this.id = id;
        this.code = code;
